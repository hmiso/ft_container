...
/*   Updated: 2021/06/27 19:50:18 by hmiso            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void test_map()
{
	...
	/* Range constrcutor */
	{
		...
		fs << "    ft_map.insert(std::make_pair(range_int[i], range_str[i]));\n";
	...
	/* Size */
	{
		...
		ft_map.insert(std::make_pair(42, "Represent"));
		...
		fs << "    ft_map.insert(std::make_pair(range_int[i], range_str[i]));\n";
		fs << "Sending output...\n";
		fs << "ft_map.insert(std::make_pair(42, \"Represent\"));\n";
		fs << "\nCompared with:\n";
		fs << "¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯\n";
		fs << "const int range_int[] = {9, -84, -45, -67, -9};\n";
		fs << "const std::string range_str[] = {\"One\", \"Two\", \"Three\", \"Four\", \"Five\"};\n";
	...
	/* Insert single */
	{
		...
		ft_map.insert(std::make_pair(42, "La famille"));
		...
		fs << "¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯\n";
		fs << "ft::map<int, std::string> ft_map;\n";
		fs << "ft_map.insert(std::make_pair(42, \"La famille\"));\n";
		fs << "\nCompared with:\n";
		fs << "¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯\n";
		fs << "std::map<int, std::string> stl_map;\n";
	...
	/* Insert hint */
	{
		...
		ft_map.insert(++(ft_map.begin()), std::make_pair(42, "Nice"));
		...
		fs << "for (int i = 0; i < 5; i++)\n";
		fs << "    ft_map.insert(std::make_pair(range_int[i], range_str[i]));\n";
		fs << "ft_map.insert(++(ft_map.begin()), std::make_pair(42, \"Nice\"));\n";
		fs << "\nCompared with:\n";
		fs << "¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯\n";
		fs << "const int range_int[] = {584, 96, 21, -54, 36};\n";
		fs << "const std::string range_str[] = {\"One\", \"Two\", \"Three\", \"Four\", \"Five\"};\n";
	...
	/* Insert Range */
	{
		...
		for (int i = 0; i < 5; i++)
		{
			...
			ft_map_one.insert(std::make_pair(range_int[i], range_str[i]));
			stl_map_two.insert(std::make_pair(range_int[i] + 266, range_str[i] + "_two"));
			ft_map_two.insert(std::make_pair(range_int[i] + 266, range_str[i] + "_two"));
		}
		...
		fs << "for (int i = 0; i < 5; i++)\n";
		fs << "{\n";
		fs << "	ft_map_one.insert(std::make_pair(range_int[i], range_str[i]));\n";
		fs << "	ft_map_two.insert(std::make_pair(range_int[i] + 266, range_str[i] + \"_two\"));\n";
		fs << "}\n";
		fs << "Sending output...\n";
	...
	/* Swap */
	{
		...
		for (int i = 0; i < 5; i++)
		{
			...
			ft_map_two.insert(std::make_pair(range_int[i] + 120, range_str[i]));
		}
		...
		fs << "{\n";
		fs << "		ft_map_one.insert(std::make_pair(range_int[i], range_str[i]));\n";
		fs << "		ft_map_two.insert(std::make_pair(range_int[i] + 120, range_str[i]));\n";
		fs << "}\n";
		fs << "Sending Output...\n";
	...
	/* Value comp */
	{
		...
		bool ft_res = ft_key(std::make_pair(99, "End"), std::make_pair(42, "Noice"));
		...
		fs << "bool ft_res = ft_key(std::make_pair(99, \"End\"), std::make_pair(42, \"Noice\"));\n";
		fs << "\nCompared with:\n";
		fs << "¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯\n";
